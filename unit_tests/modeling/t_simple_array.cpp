...
BOOST_AUTO_TEST_CASE(tarray_create_array_of_character_objects)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tCharacter>()[0]->asCharacter(), 'a');
    BOOST_CHECK_EQUAL(arr->asArray<tCharacter>()[1]->asCharacter(), 'b');
    BOOST_CHECK_EQUAL(arr->asArray<tCharacter>()[2]->asCharacter(), 'c');
}
...
BOOST_AUTO_TEST_CASE(tarray_create_array_of_integer_objects)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tInteger>()[0]->asInteger(), 1);
    BOOST_CHECK_EQUAL(arr->asArray<tInteger>()[1]->asInteger(), 2);
    BOOST_CHECK_EQUAL(arr->asArray<tInteger>()[2]->asInteger(), 3);
}
...
BOOST_AUTO_TEST_CASE(tarray_create_array_of_float_objects)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tFloat>()[0]->asFloat(), 1.1);
    BOOST_CHECK_EQUAL(arr->asArray<tFloat>()[1]->asFloat(), 2.2);
    BOOST_CHECK_EQUAL(arr->asArray<tFloat>()[2]->asFloat(), 3.3);
}
...
BOOST_AUTO_TEST_CASE(tarray_create_array_of_string_objects)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tString>()[0]->asString(), "test1");
    BOOST_CHECK_EQUAL(arr->asArray<tString>()[1]->asString(), "test2");
    BOOST_CHECK_EQUAL(arr->asArray<tString>()[2]->asString(), "test3");
}
...
BOOST_AUTO_TEST_CASE(tarray_create_array_of_boolean_objects)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tBoolean>()[0]->asBoolean(), true);
    BOOST_CHECK_EQUAL(arr->asArray<tBoolean>()[1]->asBoolean(), false);
    BOOST_CHECK_EQUAL(arr->asArray<tBoolean>()[2]->asBoolean(), true);
}
...
BOOST_AUTO_TEST_CASE(tarray_create_array_of_array_of_boolean_objects)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tArray<tBoolean>>()[0]->asArray<tBoolean>()[0]->asBoolean(), true);
    BOOST_CHECK_EQUAL(arr->asArray<tArray<tBoolean>>()[0]->asArray<tBoolean>()[1]->asBoolean(), false);
    BOOST_CHECK_EQUAL(arr->asArray<tArray<tBoolean>>()[0]->asArray<tBoolean>()[2]->asBoolean(), true);
}
...
BOOST_AUTO_TEST_CASE(tarray_of_characters_has_default_value_zero)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tCharacter>()[0]->asCharacter(), 0);
    BOOST_CHECK_EQUAL(arr->asArray<tCharacter>()[1]->asCharacter(), 0);
    BOOST_CHECK_EQUAL(arr->asArray<tCharacter>()[2]->asCharacter(), 0);
}

BOOST_AUTO_TEST_CASE(tarray_of_integers_has_default_value_zero)
{
    std::shared_ptr<Object> arr = tArray<tInteger>::value(3);
    BOOST_CHECK_EQUAL(arr->asArray<tInteger>()[0]->asInteger(), 0);
    BOOST_CHECK_EQUAL(arr->asArray<tInteger>()[1]->asInteger(), 0);
    BOOST_CHECK_EQUAL(arr->asArray<tInteger>()[2]->asInteger(), 0);
}
...
BOOST_AUTO_TEST_CASE(tarray_of_floats_has_default_value_zero_point_zero)
{
    ...
    BOOST_CHECK(arr->asArray<tFloat>()[0]->asFloat() - 0.0 < 0.001);
    BOOST_CHECK(arr->asArray<tFloat>()[1]->asFloat() - 0.0 < 0.001);
    BOOST_CHECK(arr->asArray<tFloat>()[2]->asFloat() - 0.0 < 0.001);
}

BOOST_AUTO_TEST_CASE(tarray_of_strings_has_default_value_empty)
{
    std::shared_ptr<Object> arr = tArray<tString>::value(3);
    BOOST_CHECK_EQUAL(arr->asArray<tString>()[0]->asString(), "");
    BOOST_CHECK_EQUAL(arr->asArray<tString>()[1]->asString(), "");
    BOOST_CHECK_EQUAL(arr->asArray<tString>()[2]->asString(), "");
}
...
BOOST_AUTO_TEST_CASE(tarray_of_booleans_has_default_value_false)
{
    ...
    BOOST_CHECK_EQUAL(arr->asArray<tBoolean>()[1]->asBoolean(), false);
    BOOST_CHECK_EQUAL(arr->asArray<tBoolean>()[2]->asBoolean(), false);
}

BOOST_AUTO_TEST_CASE(tarray_of_booleans_loop)
{
    std::shared_ptr<Object> arr = tArray<tBoolean>::value(3);
    std::shared_ptr<Object> * nativeArr = arr->asArray<tBoolean>();
